...
```
<i>
 --embed-certs=true: When set to true, the content of the certificate and key files will be embedded directly into the kubeconfig file, instead of just linking to the file paths.
</i>
